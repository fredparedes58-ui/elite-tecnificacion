...
-- VERSIÓN CORREGIDA: Agrega columna 'role' a team_members
-- ============================================================
-- EJECUTA ESTE SCRIPT EN SUPABASE SQL EDITOR
-- ============================================================

-- ============================================================
-- PASO 0: ASEGURAR QUE team_members TIENE LA COLUMNA role
-- ============================================================
...
-- Agregar constraint para validar los valores de role
ALTER TABLE team_members DROP CONSTRAINT IF EXISTS team_members_role_check;
ALTER TABLE team_members
ADD CONSTRAINT team_members_role_check 
CHECK (role IN ('coach', 'admin', 'player', 'parent'));

-- Crear índice para mejorar el rendimiento
CREATE INDEX IF NOT EXISTS idx_team_members_role ON team_members(role);

COMMENT ON COLUMN team_members.role IS 'Rol del usuario en el equipo: coach, admin, player, parent';
...
-- Verificar que la columna role existe en team_members
SELECT 
  column_name,
  data_type,
  column_default
...
-- NOTAS IMPORTANTES
-- ============================================================
-- 1. Este script agrega la columna 'role' a team_members si no existe
-- 2. Los roles disponibles son: 'coach', 'admin', 'player', 'parent'
-- 3. Para crear una relación padre-hijo, ejecuta:
--    INSERT INTO parent_child_relationships (parent_id, child_id, team_id)
--    VALUES ('parent_uuid', 'child_uuid', 'team_uuid');
-- 4. Los padres pueden marcar asistencia entrenamiento por entrenamiento
-- 5. El campo marked_by se llena automáticamente con el ID del usuario que marca
-- ============================================================
