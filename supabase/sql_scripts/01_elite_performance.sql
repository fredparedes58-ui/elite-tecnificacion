-- =============================================================================
-- SCRIPT 1 — Elite Performance: schema completo (tipos, tablas, RLS, triggers)
-- =============================================================================
-- EJECUTAR SOLO UNA VEZ en un proyecto nuevo. Si ya tienes profiles, players,
-- sessions, bookings, wallets, stats y el trigger on_auth_user_created, OMITE
-- este script y pasa al Script 2.
-- =============================================================================
...
-- Si la tabla bookings ya existía sin "attended", añadir la columna
